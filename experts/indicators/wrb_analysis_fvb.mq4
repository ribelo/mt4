...
int start() {
    ...
    for (i = 1; i < limit; i++) {
        ...
        if (_fvb(candle, i, Bars, look_for_zone, use_conf_h_zone, r) != 0) {
            body_fvb_open[r[0]] = Open[r[0]];
            body_fvb_close[r[0]] = Close[r[0]];
            body_fvb_open[r[1]] = Open[r[1]];
            body_fvb_close[r[1]] = Close[r[1]];
            if (draw_zone == true) {
