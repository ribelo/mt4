...
int start() {
    ...
    for (i = limit; i >= 0; i--) {
        if (pattern_a == true) {
            if (_conf_a(candle, i, Bars, r) != 0) {
                conf_body_open[r[0]] = Open[r[0]];
                conf_body_close[r[0]] = Close[r[0]];
                for (j = 1; j <= r[1] - r[0]; j++) {
                    conf_body_open[r[0] + j] = Open[r[0] + j];
                    conf_body_close[r[0] + j] = Close[r[0] + j];
                }
                if (make_text == true) {
                ...
                if (send_notification == true) {
                    if (i == 1) {
                        if (r[3] == 1) {
                            SendNotification("confirmation bull a at " + TimeToStr(Time[i]));
                        } else if (r[3] == -1) {
                            SendNotification("confirmation bear a at " + TimeToStr(Time[i]));
                        }
                    }
                }
                continue;
        ...
        if (pattern_b == true) {
            if (_conf_b(candle, i, Bars, r) != 0) {
                ...
                if (send_notification == true) {
                    if (i == 1) {
                        if (r[3] == 1) {
                            SendNotification("confirmation bull b at " + TimeToStr(Time[i]));
                        } else if (r[3] == -1) {
                            SendNotification("confirmation bear b at " + TimeToStr(Time[i]));
                        }
                    }
                }
                continue;
        ...
        if (pattern_c == true) {
            if (_conf_c(candle, i, Bars, r) != 0) {
                ...
                if (send_notification == true) {
                    if (i == 1) {
                        if (r[3] == 1) {
                            SendNotification("confirmation bull c at " + TimeToStr(Time[i]));
                        } else if (r[3] == -1) {
                            SendNotification("confirmation bear c at " + TimeToStr(Time[i]));
                        }
                    }
                }
                continue;
        ...
        if (pattern_d == true) {
            if (_conf_d(candle, i, Bars, r) != 0) {
                ...
                if (send_notification == true) {
                    if (i == 1) {
                        if (r[3] == 1) {
                            SendNotification("confirmation bull d at " + TimeToStr(Time[i]));
                        } else if (r[3] == -1) {
                            SendNotification("confirmation bear d at " + TimeToStr(Time[i]));
                        }
                    }
                }
                continue;
        ...
        if (pattern_e == true) {
            if (_conf_e(candle, i, Bars, r) != 0) {
                ...
                if (send_notification == true) {
                    if (i == 1) {
                        if (r[3] == 1) {
                            SendNotification("confirmation bull e at " + TimeToStr(Time[i]));
                        } else if (r[3] == -1) {
                            SendNotification("confirmation bear e at " + TimeToStr(Time[i]));
                        }
                    }
                }
                continue;
        ...
        if (pattern_h1 == true) {
            if (_conf_h1(candle, i, Bars, contraction_size, r) != 0) {
                conf_body_open[r[0]] = Open[r[0]];
                conf_body_close[r[0]] = Close[r[0]];
                conf_body_open[r[1]] = Open[r[1]];
                conf_body_close[r[1]] = Close[r[1]];
                for (j = 1; j < r[1] - r[0]; j++) {
                ...
                if (send_notification == true) {
                    if (i == 1) {
                        if (r[3] == 1) {
                            SendNotification("confirmation bull h1 at " + TimeToStr(Time[i]));
                        } else if (r[3] == -1) {
                            SendNotification("confirmation bear h1 at " + TimeToStr(Time[i]));
                        }
                    }
                }
                continue;
        ...
        if (pattern_h2 == true) {
            if (_conf_h2(candle, i, Bars, contraction_size, r) != 0) {
                conf_body_open[r[0]] = Open[r[0]];
                conf_body_close[r[0]] = Close[r[0]];
                conf_body_open[r[1]] = Open[r[1]];
                conf_body_close[r[1]] = Close[r[1]];
                ...
                if (send_notification == true) {
                    if (i == 1) {
                        if (r[3] == 1) {
                            SendNotification("confirmation bull h2 at " + TimeToStr(Time[i]));
                        } else if (r[3] == -1) {
                            SendNotification("confirmation bear h2 at " + TimeToStr(Time[i]));
                        }
                    }
                }
                continue;
        ...
        if (pattern_h3 == true) {
            if (_conf_h3(candle, i, Bars, contraction_size, r) != 0) {
                conf_body_open[r[0]] = Open[r[0]];
                conf_body_close[r[0]] = Close[r[0]];
                conf_body_open[r[1]] = Open[r[1]];
                conf_body_close[r[1]] = Close[r[1]];
                ...
                if (send_notification == true) {
                    if (i == 1) {
                        if (r[3] == 1) {
                            SendNotification("confirmation bull h3 at " + TimeToStr(Time[i]));
                        } else if (r[3] == -1) {
                            SendNotification("confirmation bear h3 at " + TimeToStr(Time[i]));
                        }
                    }
                }
                continue;
        ...
        if (pattern_h4 == true) {
            if (_conf_h4(candle, i, Bars, contraction_size, r) != 0) {
                conf_body_open[r[0]] = Open[r[0]];
                conf_body_close[r[0]] = Close[r[0]];
                conf_body_open[r[1]] = Open[r[1]];
                conf_body_close[r[1]] = Close[r[1]];
                ...
                if (send_notification == true) {
                    if (i == 1) {
                        if (r[3] == 1) {
                            SendNotification("confirmation bull h4 at " + TimeToStr(Time[i]));
                        } else if (r[3] == -1) {
                            SendNotification("confirmation bear h4 at " + TimeToStr(Time[i]));
                        }
                    }
                }
                continue;
