                           ...
                           color arrow_color = CLR_NONE)
{
   ...
   if (cmd == OP_BUYSTOP  ||  cmd == OP_SELLSTOP  ||  cmd == OP_BUYLIMIT  ||  cmd == OP_SELLLIMIT) {
      ...
      while (!exit_loop) {
         ...
         if (exit_loop) {
            ...
            if (cnt > O_R_Setting_max_retries) {
               OrderReliablePrint("Retry attempts maxed at " + O_R_Setting_max_retries);
            }
         } else {
            OrderReliablePrint("Result of attempt " + cnt + " of " + O_R_Setting_max_retries + ": Retryable error: " + OrderReliableErrTxt(err));
            OrderReliablePrint("~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~  ~");
      ...
      if (!limit_to_market) {
         OrderReliablePrint("Failed to execute stop or limit order after " + O_R_Setting_max_retries + " retries");
   ...
   if ((cmd == OP_BUY) || (cmd == OP_SELL)) {
      ...
      OrderReliablePrint("Failed to execute OP_BUY/OP_SELL, after " + O_R_Setting_max_retries + " retries");
      OrderReliablePrint("Failed trade: " + OrderType2String(cmd) + " " + DoubleToStr(volume, 2) + " lots  " + symbol +
                         "@" + price + " tp@" + takeprofit + " sl@" + stoploss);
      OrderReliablePrint("Last error: " + OrderReliableErrTxt(err));
      OrderReliablePrint("•  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •  •");
                         ...
                         color arrow_color = CLR_NONE)
{
   ...
   if (result) {
      if (err == ERR_NO_RESULT) {
          OrderReliablePrint("Server reported OrderModify() did not change TP or SL: " + ticket + " " + symbol +
                         "@" + price + " tp@" + takeprofit + " sl@" + stoploss);
                        ...
                        int slippage, color arrow_color = CLR_NONE)
{
   ...
   if (result) {
      ...
      */
      ...
      OrderReliablePrint("Failed to execute close after " + O_R_Setting_max_retries + " retries");
...
bool OrderDeleteReliable(int ticket)
{
   ...
   if (result) {
      ...
      OrderReliablePrint("Failed to execute delete after " + O_R_Setting_max_retries + " retries");
...
bool O_R_CheckForHistory(int ticket)
{
   ...
   while (!exit_loop) {
      ...
      if (!(success || exit_loop)) {
         OrderReliablePrint("Did not find #"+ticket+" in history, sleeping, then doing retry #"+cnt);
         O_R_Sleep(O_R_Setting_sleep_time, O_R_Setting_sleep_max);
      }
   }
   ...
   if (!success) {
      OrderReliablePrint("Never found #"+ticket+" in history! crap!");
   }
   return(success);
}
